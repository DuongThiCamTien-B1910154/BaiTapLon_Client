<template>
  <v-container>
    ...
    <v-row>
      <v-col class="pt-5">
        <v-btn class="pink white--text" :to="{ name: 'add-pro' }">
      ...
      <div>
        <h5 class="pt-5">
          Sắp xếp số lượng:&nbsp;&nbsp;
          <v-btn @click="sortByAsc" class="pink white--text">
            <i class="fa-solid fa-up-long"></i>
          </v-btn>
          &nbsp;&nbsp;
          <v-btn @click="sortByDesc" class="pink white--text"
